...
const navigation = [
  {
    title: 'Cases',
    links: [
      { title: 'Magalu', href: '/work/magalu' },
      { title: 'Momentum', href: '/work/momentum' },
      { title: 'Autovoxx', href: '/work/autovoxx' },
      {
        title: (
          <>
      ...
      <ul role="list" className="grid grid-cols-2 gap-8 sm:grid-cols-3">
        {navigation.map((section, sectionIndex) => (
          <li key={sectionIndex}>
            ...
            <ul role="list" className="mt-4 text-sm text-gray-600">
  ...
  return (
    <form className="max-w-sm">
      <h2 className="font-display text-base font-semibold text-neutral-950">
        Receba insights de tecnologia
      </h2>
      <p className="mt-4 text-sm text-neutral-600">
        Novidades sobre software sob medida, GCPro e gestão de squads.
      </p>
